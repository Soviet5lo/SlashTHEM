...
# if defined(MICRO) || defined(WIN32) || defined(UNIX)
...
# endif
	...
	{"hilite_obj_piles",	&iflags.hilite_obj_piles, FALSE, SET_IN_GAME},
...
/* 5lo: Set to false because of a bug where colors are messed up if the text stretches beyond its line. */
	{"statuscolors", &iflags.use_status_colors, FALSE, SET_IN_GAME}, 
#else
	{"statuscolors", (boolean *)0, FALSE, SET_IN_GAME},
#endif
#ifdef MENU_COLOR
# ifdef MICRO
