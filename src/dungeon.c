...
{
	if (In_endgame(&u.uz))
		return((xchar)(/*depth(&sanctum_level)*/100 + u.ulevel/2));
	else
		if (u.uhave.amulet)
...
#define TAB "  "
#define D_BULLET ""
#define PREFIX TAB TAB D_BULLET
...
STATIC_OVL void
print_mapseen(win, mptr, printdun, willdump, final)
winid win;
mapseen *mptr;
boolean printdun;
boolean willdump; /**< if information should be dumped to file */
