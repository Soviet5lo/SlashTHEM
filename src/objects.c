...
CONTAINER("ugly backpack", (char *)0,   1, 0, 0, 0,   0, 5, 100, CLOTH, CLR_MAGENTA),
...
/* Enchantment */
SCROLL("confuse monster",       "NR 9",                 P_ENCHANTMENT_SPELL,  1,  27, 300, CLR_MAGENTA),
...
SCROLL("standard id",           "WHAT THE FUCK IS THIS",P_NONE, 1,  10, 300, CLR_ORANGE),
...
SCROLL("wishing",		"TRICK 13",		P_NONE,  1,  1, 300, CLR_WHITE),
...
#endif
SCROLL("ice",		"IMMORTAL DUNGEON",	      P_NONE,  1, 10, 300, CLR_GREEN),
SCROLL("clouds",		"VOLARE",	      P_NONE,  1, 10, 300, CLR_BRIGHT_BLUE),
SCROLL("root password detection","XYZZY",	      P_NONE,  1,  5, 300, CLR_GRAY),
SCROLL("trap creation","TOP SECRET DO NOT READ",      P_NONE,  1, 10, 300, CLR_BLACK),
SCROLL("sleep",      "I AM SO FUCKING TIRED",         P_NONE, 1,  10, 300, CLR_BRIGHT_MAGENTA),
