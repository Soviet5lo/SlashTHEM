...
SCROLL("healing",               "PHOL ENDE WODAN",      P_NONE, 1,  10, 300, CLR_BRIGHT_CYAN),
SCROLL("standard id",           "EIRIS SAZUN IDISI",    P_NONE, 1,  10,  10, CLR_ORANGE),
...
SCROLL("WC",		"ACHAT SHTAYIM SHALOSH",	      P_NONE,  1,  5, 250, CLR_WHITE),
...
#if 0 /* 5lo: Shuffled patch descriptions were used for scrolls above */
...
WAND("punishment",     "walnut",      5, 150, 1, NODIR,     WOOD,    HI_WOOD),
...
WAND("trap creation",   "elm",  5, 150, 1, NODIR,     WOOD,  HI_WOOD),
WAND("darkness",   "cedar",  5, 150, 1, NODIR,     WOOD,  HI_WOOD),
WAND("magic mapping",   "palmwood",  5, 150, 1, NODIR,     WOOD,  HI_WOOD),
...
WAND("haste monster",  "titanium",    5, 200, 1, IMMEDIATE, METAL,   HI_METAL),
