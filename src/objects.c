...
RING("disarming",     GLIB,     "wet",      100,  5, 1, 0, 1, VEGGY, CLR_BRIGHT_BLUE),
...
RING("gain constitution", 0,   "opal",      150, 33, 1, 1, 7, MINERAL,  HI_MINERAL),
...
CONTAINER("sack", "bag",                0, 0, 0, 0,  30, 5,   2, CLOTH, HI_CLOTH),
CONTAINER("oilskin sack", "bag",        0, 0, 0, 0,  20, 5, 100, CLOTH, HI_CLOTH),
CONTAINER("ugly backpack", (char *)0,   1, 0, 0, 0,   0, 5,  50, CLOTH, CLR_MAGENTA),
...
TOOL("tallow candle", "candle", 0, 1, 0, 0,  50,  0,   1, WAX, CLR_WHITE),
TOOL("wax candle", "candle",    0, 1, 0, 0,  40,  0,   2, WAX, CLR_WHITE),
TOOL("magic candle",  "candle", 0, 1, 1, 0,   5,  0, 500, WAX, CLR_WHITE),
TOOL("oil lamp", "lamp",        0, 0, 0, 0,  25,  0,  10, COPPER, CLR_YELLOW),
TOOL("brass lantern", (char *)0,1, 0, 0, 0,  15,  0,  12, COPPER, CLR_YELLOW),
TOOL("magic lamp", "lamp",      0, 0, 1, 0,  10,  0,1000, COPPER, CLR_YELLOW),
...
TOOL("wooden flute", "flute",   0, 0, 0, 0,   2,  0,  12, WOOD, HI_WOOD),
TOOL("magic flute", "flute",    0, 0, 1, 1,   1,  0,  36, WOOD, HI_WOOD),
TOOL("tooled horn", "horn",     0, 0, 0, 0,   2,  0,  15, BONE, CLR_WHITE),
...
SCROLL("summon undead",         "NO SPACE",             P_ATTACK_SPELL, 1,   5, 250, CLR_WHITE),
/* Enchantment */
...
SCROLL("inventory id",          "NOW YOU SEE IT",       P_DIVINATION_SPELL, 1,  5, 250, CLR_YELLOW),
...
SCROLL("gain mana",             "DAMN IT",              P_DIVINATION_SPELL, 1,  5, 150, CLR_BRIGHT_MAGENTA),
/* Enchantment */
...
SCROLL("amnesia",               "DUAM XNAHT",           P_NONE, 1,  10, 200, CLR_BRIGHT_BLUE),
SCROLL("healing",               "LIFE RESTORATION",     P_NONE, 1,  10, 300, CLR_BRIGHT_CYAN),
SCROLL("standard id",           "WHAT THE FUCK IS THIS",P_NONE, 1,  10,  10, CLR_ORANGE),
...
SCROLL("proof armor",         "I AM THE KING",          P_NONE, 1,  5, 100, CLR_ORANGE),
SCROLL("proof weapon",         "YOU ARE DOOMED",        P_NONE, 1,  5, 100, CLR_GRAY),
...
SCROLL("sinking",		"SPORKHACK ASCENSION",	      P_NONE,  1,  5, 250, CLR_CYAN),
SCROLL("WC",		"LETS PLAY NETHACK",	      P_NONE,  1,  5, 250, CLR_WHITE),
...
#endif
SCROLL("ice",		"IMMORTAL DUNGEON",	      P_NONE,  1, 10, 200, CLR_GREEN),
SCROLL("clouds",		"VOLARE",	      P_NONE,  1, 10, 200, CLR_BRIGHT_BLUE),
SCROLL("root password detection","XYZZY",	      P_NONE,  1,  5, 200, CLR_GRAY),
SCROLL("trap creation","TOP SECRET DO NOT READ",      P_NONE,  1, 10, 200, CLR_BLACK),
SCROLL("sleep",      "I AM SO FUCKING TIRED",         P_NONE, 1,  10, 200, CLR_BRIGHT_MAGENTA),
...
SCROLL((char *)0,               "VAS CORP BET MANI", P_NONE,    1,   0, 100, CLR_GRAY), /* Ultima */
/* TODO: Cull a majority of unfitting scroll appearances above and below...*/
SCROLL((char *)0,               "CLONE MONSTER",  P_NONE,     1,   0, 100, CLR_BRIGHT_GREEN),
SCROLL((char *)0,               "RESURRECTION",  P_NONE,     1,   0, 100, CLR_WHITE),
SCROLL((char *)0,               "APOCALYPSE",  P_NONE,     1,   0, 100, CLR_BLACK),
SCROLL((char *)0,               "WORLD FALL",  P_NONE,     1,   0, 100, CLR_BLACK),
SCROLL((char *)0,               "CATACLYSM",  P_NONE,     1,   0, 100, CLR_BLACK),
SCROLL((char *)0,               "HAHAHAHAHAHAHA",  P_NONE,     1,   0, 100, CLR_BRIGHT_GREEN),
SCROLL((char *)0,               "LA VIVME",  P_NONE,     1,   0, 100, CLR_GREEN),
SCROLL((char *)0,               "U FOKIENG SUK",  P_NONE,     1,   0, 100, CLR_RED),
SCROLL((char *)0,               "SIR I HAVE TO TAKE A SHIT",  P_NONE,     1,   0, 100, CLR_BLACK),
SCROLL((char *)0,               "YOU DONT STAND A CHANCE",  P_NONE,     1,   0, 100, CLR_WHITE),
SCROLL((char *)0,               "VUS AS CORIUMA",  P_NONE,     1,   0, 100, CLR_GREEN),
SCROLL((char *)0,               "SE FERSE PARUM",  P_NONE,     1,   0, 100, CLR_ORANGE),
SCROLL((char *)0,               "ABOR EFECTOR",  P_NONE,     1,   0, 100, CLR_GRAY),
SCROLL((char *)0,               "ALIUS PRA",  P_NONE,     1,   0, 100, CLR_BLACK),
SCROLL((char *)0,               "AM PO COLVATIO",  P_NONE,     1,   0, 100, CLR_GREEN),
SCROLL((char *)0,               "CO APPESTUS",  P_NONE,     1,   0, 100, CLR_RED),
SCROLL((char *)0,               "CONE ALACIO",  P_NONE,     1,   0, 100, CLR_BROWN),
SCROLL((char *)0,               "CRIAEDO",  P_NONE,     1,   0, 100, CLR_MAGENTA),
SCROLL((char *)0,               "DEVIENEX COER",  P_NONE,     1,   0, 100, CLR_CYAN),
SCROLL((char *)0,               "DUCTUM ADIS",  P_NONE,     1,   0, 100, CLR_GRAY),
SCROLL((char *)0,               "INE IGO PIO",  P_NONE,     1,   0, 100, CLR_ORANGE),
SCROLL((char *)0,               "INQUE COMUS",  P_NONE,     1,   0, 100, CLR_BRIGHT_GREEN),
SCROLL((char *)0,               "INS CUBITOR",  P_NONE,     1,   0, 100, CLR_YELLOW),
SCROLL((char *)0,               "IUSTIO QUE PIS",  P_NONE,     1,   0, 100, CLR_BRIGHT_BLUE),
SCROLL((char *)0,               "LAM EQUENUS",  P_NONE,     1,   0, 100, CLR_BRIGHT_MAGENTA),
SCROLL((char *)0,               "LENS ALITUS",  P_NONE,     1,   0, 100, CLR_BRIGHT_CYAN),
SCROLL((char *)0,               "MA MILLOCOR",  P_NONE,     1,   0, 100, CLR_WHITE),
SCROLL((char *)0,               "NIOQUO TARGO",  P_NONE,     1,   0, 100, CLR_BLACK),
SCROLL((char *)0,               "NONO STENTUM",  P_NONE,     1,   0, 100, CLR_GREEN),
SCROLL((char *)0,               "PAS DIO LEO",  P_NONE,     1,   0, 100, CLR_RED),
SCROLL((char *)0,               "PONUS MOSTAS",  P_NONE,     1,   0, 100, CLR_BROWN),
SCROLL((char *)0,               "PRIUS SA",  P_NONE,     1,   0, 100, CLR_MAGENTA),
SCROLL((char *)0,               "PROR PERPERCA",  P_NONE,     1,   0, 100, CLR_CYAN),
SCROLL((char *)0,               "PUTIUS CONSIO",  P_NONE,     1,   0, 100, CLR_GRAY),
SCROLL((char *)0,               "PUTO FER LO",  P_NONE,     1,   0, 100, CLR_ORANGE),
SCROLL((char *)0,               "REQUICO SIDES",  P_NONE,     1,   0, 100, CLR_BRIGHT_GREEN),
SCROLL((char *)0,               "SALIQUAS",  P_NONE,     1,   0, 100, CLR_YELLOW),
SCROLL((char *)0,               "SERO GRIUS",  P_NONE,     1,   0, 100, CLR_BRIGHT_BLUE),
SCROLL((char *)0,               "OXHE SRIAN",  P_NONE,     1,   0, 100, CLR_BRIGHT_MAGENTA),
SCROLL((char *)0,               "SEVER OPEROFOR",  P_NONE,     1,   0, 100, CLR_BRIGHT_CYAN),
SCROLL((char *)0,               "SUS COMNITUS",  P_NONE,     1,   0, 100, CLR_WHITE),
SCROLL((char *)0,               "SUS QUO SUM",  P_NONE,     1,   0, 100, CLR_BLACK),
SCROLL((char *)0,               "SUSY THENSE",  P_NONE,     1,   0, 100, CLR_RED),
SCROLL((char *)0,               "TO DO CANCENUS",  P_NONE,     1,   0, 100, CLR_GREEN),
SCROLL((char *)0,               "TRAETOR HORIGO",  P_NONE,     1,   0, 100, CLR_BROWN),
SCROLL((char *)0,               "UTOR COMPERIO",  P_NONE,     1,   0, 100, CLR_MAGENTA),
SCROLL((char *)0,               "VITIO PUS RO",  P_NONE,     1,   0, 100, CLR_CYAN),
SCROLL((char *)0,               "VITIO SUS",  P_NONE,     1,   0, 100, CLR_GRAY),
SCROLL((char *)0,               "VO AMMITAM SA",  P_NONE,     1,   0, 100, CLR_ORANGE),
SCROLL((char *)0,               "VO FACIAM",  P_NONE,     1,   0, 100, CLR_BRIGHT_GREEN),
SCROLL((char *)0,               "WIZZY LABOR CO",  P_NONE,     1,   0, 100, CLR_YELLOW),
SCROLL((char *)0,               "KAME HAME HA",  P_NONE,     1,   0, 100, CLR_BRIGHT_BLUE),
SCROLL((char *)0,               "SECTUM SEMPRA",  P_NONE,     1,   0, 100, CLR_BRIGHT_MAGENTA),
SCROLL((char *)0,               "EYGOORTS TOGAAL JEZEHH",  P_NONE,     1,   0, 100, CLR_BRIGHT_MAGENTA),
SCROLL((char *)0,               "YOU WILL DIE A SLOW SLOW DEATH",  P_NONE,     1,   0, 100, CLR_BROWN),
SCROLL((char *)0,               "BLUE SCREEN OF DEATH",  P_NONE,     1,   0, 100, CLR_BRIGHT_BLUE),
SCROLL((char *)0,               "SEE IF I CARE",  P_NONE,     1,   0, 100, CLR_RED),
SCROLL((char *)0,               "VIRUS INFECTION DETECTED",  P_NONE,     1,   0, 100, CLR_ORANGE),
SCROLL((char *)0,               "INTRUDER ALERT",  P_NONE,     1,   0, 100, CLR_GRAY),
SCROLL((char *)0,               "USER DEATH IMMINENT",  P_NONE,     1,   0, 100, CLR_WHITE),
SCROLL((char *)0,               "I HERE SOMETHING",  P_NONE,     1,   0, 100, CLR_GRAY),
SCROLL((char *)0,               "GOT SOMETHING FOUR YOU",  P_NONE,     1,   0, 100, CLR_RED),
SCROLL((char *)0,               "MY PRIVATE IS TENMETERS ACROSS",  P_NONE,     1,   0, 100, CLR_BROWN),
SCROLL((char *)0,               "ECNETOPINMO",  P_NONE,     1,   0, 100, CLR_RED),
SCROLL((char *)0,               "SUTSI",  P_NONE,     1,   0, 100, CLR_MAGENTA),
SCROLL((char *)0,               "YIK MECH SHEGOTH",  P_NONE,     1,   0, 100, CLR_GREEN),
SCROLL((char *)0,               "KAPOW",  P_NONE,     1,   0, 100, CLR_RED),
SCROLL((char *)0,               "YNORI ERUP",  P_NONE,     1,   0, 100, CLR_BRIGHT_BLUE),
SCROLL((char *)0,               "REGNAD",  P_NONE,     1,   0, 100, CLR_ORANGE),
SCROLL((char *)0,               "ODIV",  P_NONE,     1,   0, 100, CLR_WHITE),
SCROLL((char *)0,               "ZTORF",  P_NONE,     1,   0, 100, CLR_GREEN),
SCROLL((char *)0,               "HITME",  P_NONE,     1,   0, 100, CLR_CYAN),
SCROLL((char *)0,               "MANANNANMACLIR",  P_NONE,     1,   0, 100, CLR_BRIGHT_CYAN),
SCROLL((char *)0,               "MEAD NI NAJAP",  P_NONE,     1,   0, 100, CLR_CYAN),
SCROLL((char *)0,               "MKMNFST",  P_NONE,     1,   0, 100, CLR_YELLOW),
SCROLL((char *)0,               "DOGO FUTSF",  P_NONE,     1,   0, 100, CLR_BROWN),
SCROLL((char *)0,               "MANUALIRK GLEKNOW MIZK",  P_NONE,     1,   0, 100, CLR_BRIGHT_CYAN),
SCROLL((char *)0,               "KLATHA DATHA NY ARYATHA",  P_NONE,     1,   0, 100, CLR_ORANGE),
SCROLL((char *)0,               "IAZNAB",  P_NONE,     1,   0, 100, CLR_BRIGHT_GREEN),
SCROLL((char *)0,               "WOPAK",  P_NONE,     1,   0, 100, CLR_MAGENTA),
SCROLL((char *)0,               "HCUO",  P_NONE,     1,   0, 100, CLR_BLACK),
SCROLL((char *)0,               "ENO OWT EERHT",  P_NONE,     1,   0, 100, CLR_BRIGHT_MAGENTA),
SCROLL((char *)0,               "GNOZAB",  P_NONE,     1,   0, 100, CLR_GREEN),
SCROLL((char *)0,               "ABABILA",  P_NONE,     1,   0, 100, CLR_BLACK),
SCROLL((char *)0,               "MUNCH MUNCH",  P_NONE,     1,   0, 100, CLR_BRIGHT_GREEN),
SCROLL((char *)0,               "FROTZ",  P_NONE,     1,   0, 100, CLR_YELLOW),
SCROLL((char *)0,               "EDEVESH HANAGASH",  P_NONE,     1,   0, 100, CLR_ORANGE),
SCROLL((char *)0,               "YIKES",  P_NONE,     1,   0, 100, CLR_RED),
SCROLL((char *)0,               "IDNUM AIROLG TISNART CIS",  P_NONE,     1,   0, 100, CLR_ORANGE),
SCROLL((char *)0,               "RAMBA ZAMBA",  P_NONE,     1,   0, 100, CLR_BLACK),
SCROLL((char *)0,               "KTTDLWRGT",  P_NONE,     1,   0, 100, CLR_BROWN),
SCROLL((char *)0,               "GNAY GNIY",  P_NONE,     1,   0, 100, CLR_GRAY),
SCROLL((char *)0,               "CARPE DIEM",  P_NONE,     1,   0, 100, CLR_GREEN),
SCROLL((char *)0,               "CUTME",  P_NONE,     1,   0, 100, CLR_BRIGHT_CYAN),
SCROLL((char *)0,               "FOO BAR",  P_NONE,     1,   0, 100, CLR_BROWN),
SCROLL((char *)0,               "FPMAM",  P_NONE,     1,   0, 100, CLR_BROWN),
SCROLL((char *)0,               "FOX NAWAGU",  P_NONE,     1,   0, 100, CLR_RED),
SCROLL((char *)0,               "YTTOCS PU EM MAEB",  P_NONE,     1,   0, 100, CLR_BRIGHT_CYAN),
SCROLL((char *)0,               "NADSIL SEETRURA",  P_NONE,     1,   0, 100, CLR_MAGENTA),
SCROLL((char *)0,               "ACME",  P_NONE,     1,   0, 100, CLR_GREEN),
SCROLL((char *)0,               "CHUTZPAH",  P_NONE,     1,   0, 100, CLR_CYAN),
SCROLL((char *)0,               "TLASFO SENIL",  P_NONE,     1,   0, 100, CLR_WHITE),
SCROLL((char *)0,               "RW NW PRT M HRW",  P_NONE,     1,   0, 100, CLR_RED),
SCROLL((char *)0,               "MORPH BALL",  P_NONE,     1,   0, 100, CLR_GRAY),
SCROLL((char *)0,               "TUOE DISNI",  P_NONE,     1,   0, 100, CLR_BRIGHT_GREEN),
SCROLL((char *)0,               "FASUN SEEEEP",  P_NONE,     1,   0, 100, CLR_BRIGHT_MAGENTA),
...
WAND("nothing",        "oak",       5, 100, 0, IMMEDIATE, WOOD,     HI_WOOD),
...
WAND("identify",       "wedged",    5, 250, 1, NODIR,     WOOD,     CLR_BRIGHT_GREEN),
WAND("remove curse",   "wiry",      5, 150, 1, NODIR,     METAL,    CLR_GRAY),
WAND("punishment",     "edgy",      5, 150, 1, NODIR,     PAPER,    CLR_WHITE),
...
WAND("entrapping",   "blasted",  5, 150, 1, NODIR,     MITHRIL,  CLR_BRIGHT_MAGENTA),
WAND("trap creation",   "weird",  5, 150, 1, NODIR,     BONE,  CLR_WHITE),
WAND("darkness",   "obscure",  5, 150, 1, NODIR,     SILVER,  CLR_BLACK),
WAND("magic mapping",   "shapeless",  5, 150, 1, NODIR,     DRAGON_HIDE,  CLR_BRIGHT_GREEN),
WAND("detect monsters", "exploding",  5, 150, 1, NODIR,     WOOD,     CLR_GREEN),
WAND("objection", "cinnabar", 5, 150, 1, NODIR,     SILVER,   CLR_ORANGE),
WAND("slow monster",   "tin",      45, 150, 1, IMMEDIATE, METAL,    HI_METAL),
WAND("speed monster",  "brass",    35, 150, 1, IMMEDIATE, COPPER,   HI_COPPER),
WAND("haste monster",  "royal",    5, 200, 1, IMMEDIATE, GOLD,   CLR_ORANGE),
...
WAND("summon undead", "shining",     5, 200, 1, NODIR,     GEMSTONE,     CLR_YELLOW),
WAND("fear",           "rusty",    20, 200, 1, IMMEDIATE, IRON,     CLR_RED),
WAND("wind",           "timber",     5, 200, 1, IMMEDIATE, WOOD,     CLR_BROWN),
...
WAND("full healing",   "hawthorn", 10, 300, 1, IMMEDIATE, LEATHER,  CLR_BROWN),
WAND("wonder",	"elven-lettered", 5, 150, 1, NODIR,     IRON,	 HI_METAL),
WAND("bugging",	"wooden",		5, 200, 1, NODIR,     WOOD,	 HI_METAL),
WAND("wishing",        "pine",      5, 500, 1, NODIR,     WOOD,     HI_WOOD),
WAND("acquirement",   "important",  5, 400, 1, NODIR,     SILVER,     CLR_CYAN),
WAND("clone monster",  "radiating", 5, 500, 1, IMMEDIATE, GOLD,    CLR_BRIGHT_GREEN),
WAND("charging", "buzzing",     5, 400, 1, NODIR,     METAL,     CLR_BRIGHT_CYAN),
...
WAND("acid",		"measured",	5, 200, 1, RAY,       METAL,	 HI_METAL),
WAND("solar beam",	"beaming",	5, 400, 1, RAY,       METAL,	 CLR_BRIGHT_CYAN),
/* TODO: Cull a majority of redundant/unfitting appearances below */
...
WAND((char *)0,        "mithril",   0, 150, 1, 0,         MITHRIL,  HI_SILVER),
WAND((char *)0,        "grooved",   0, 150, 1, 0,         WOOD,     HI_WOOD),
WAND((char *)0,        "bent",      0, 150, 1, 0,         METAL,    CLR_BRIGHT_GREEN),
WAND((char *)0,        "plastic",   0, 150, 1, 0,         PLASTIC,  CLR_BRIGHT_GREEN),
...
WAND((char *)0,        "birch",0, 150, 1, 0,         WOOD,    CLR_YELLOW),
...
WAND((char *)0,        "elm",0, 150, 1, 0,         WOOD,    CLR_GREEN),
...
WAND((char *)0,        "redwood",0, 150, 1, 0,         WOOD,    CLR_RED),
...
WAND((char *)0,        "silicon",0, 150, 1, 0,         MINERAL,    CLR_WHITE),
WAND((char *)0,        "titanium",0, 150, 1, 0,         METAL,    CLR_ORANGE),
...
GEM("dilithium crystal", "white",      2,  0, 4500, 15,  5, GEMSTONE, CLR_WHITE),
GEM("diamond", "white",                3,  0, 4000, 15, 10, GEMSTONE, CLR_WHITE),
GEM("ruby", "red",                     4,  0, 3500, 15,  9, GEMSTONE, CLR_RED),
GEM("jacinth", "orange",               3,  0, 3250, 15,  9, GEMSTONE, CLR_ORANGE),
GEM("sapphire", "blue",                4,  0, 3000, 15,  9, GEMSTONE, CLR_BRIGHT_BLUE),
GEM("black opal", "black",             3,  0, 2500, 15,  8, GEMSTONE, CLR_BLACK),
GEM("emerald", "green",                5,  0, 2500, 15,  8, GEMSTONE, CLR_GREEN),
GEM("turquoise", "green",              6,  0, 2000, 15,  6, GEMSTONE, CLR_GREEN),
GEM("citrine", "yellow",               4,  0, 1500, 15,  6, GEMSTONE, CLR_YELLOW),
GEM("aquamarine", "green",             6,  0, 1500, 15,  8, GEMSTONE, CLR_GREEN),
GEM("amber", "yellowish brown",        8,  0, 1000, 15,  2, GEMSTONE, CLR_BROWN),
GEM("topaz", "yellowish brown",       10,  0,  900, 15,  8, GEMSTONE, CLR_BROWN),
GEM("jet", "black",                    6,  0,  850, 15,  7, GEMSTONE, CLR_BLACK),
GEM("opal", "white",                  12,  0,  800, 15,  6, GEMSTONE, CLR_WHITE),
GEM("chrysoberyl", "yellow",           8,  0,  700, 15,  5, GEMSTONE, CLR_YELLOW),
GEM("garnet", "red",                  12,  0,  700, 15,  7, GEMSTONE, CLR_RED),
GEM("amethyst", "violet",             14,  0,  600, 15,  7, GEMSTONE, CLR_MAGENTA),
GEM("jasper", "red",                  15,  0,  500, 15,  7, GEMSTONE, CLR_RED),
GEM("fluorite", "violet",             15,  0,  400, 15,  4, GEMSTONE, CLR_MAGENTA),
GEM("obsidian", "black",               9,  0,  200, 15,  6, GEMSTONE, CLR_BLACK),
GEM("agate", "orange",                12,  0,  200, 15,  6, GEMSTONE, CLR_ORANGE),
GEM("jade", "green",                  10,  0,  300, 15,  6, GEMSTONE, CLR_GREEN),
GEM("worthless piece of white glass", "white",   76, 0, 0, 6, 5, GLASS, CLR_WHITE),
GEM("worthless piece of blue glass", "blue",     76, 0, 0, 6, 5, GLASS, CLR_BRIGHT_BLUE),
GEM("worthless piece of red glass", "red",       76, 0, 0, 6, 5, GLASS, CLR_RED),
 ...
 */
ROCK("luckstone", "gray",	0, 10,  0, 60, 15, 15, 1, 10, 7, MINERAL, CLR_GRAY),
...
ROCK("touchstone", "gray",	0,  4,  0, 60, 15, 15, 1, 10, 6, MINERAL, CLR_GRAY),
ROCK("whetstone", "gray",	0,  3,  0, 60, 15, 15, 1, 10, 7, MINERAL, CLR_GRAY),
ROCK("flint", "gray",		0, 10,  0, 60, 20, 20, 0, 10, 7, MINERAL, CLR_GRAY),
ROCK("rock", (char *)0,		1,100,  0,  0, 10, 10, 0, 10, 7, MINERAL, CLR_GRAY),
#undef GEM
#undef ROCK
