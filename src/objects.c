...
ARMOR("banded mail", (char *)0,
	1, 0, 1, 0,	73, 5, 160,  90,  4, 0, ARM_SUIT, IRON, HI_METAL),
...
HELM("elven leather helm", "leather hat",
		0, 0, 0,			6, 1,  2,   8, 8, 0, LEATHER, HI_LEATHER),
...
HELM("helm of steel", "steel helmet",
		0, 1, 0,			1, 1, 20,  50, 6, 0, MITHRIL, CLR_ORANGE),
...
GLOVES("gauntlets of steel", "steel gloves",
		0, 1,  0,			1, 1, 4, 50,  7, 0, MITHRIL, CLR_ORANGE),
...
SHIELD("steel shield", (char *)0,
		1, 0, 0, 0,	     1, 0, 120,	10,  5, 0, GOLD, CLR_YELLOW),
...
BOOTS("high boots", "jackboots",
		0, 0,  0,	  14, 2, 8, 12,  8, 0, LEATHER, HI_LEATHER),
...
FOOD("pancake",             14, 2,  0, 0, VEGGY, 200, CLR_YELLOW),
...
WAND("full healing",   "hawthorn",  5, 500, 1, IMMEDIATE, LEATHER,  CLR_BROWN),
