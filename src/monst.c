 ...
 */
	...
	A(ATTK(AT_STNG, AD_DRST, 2, 6), ATTK(AT_STNG, AD_DRDX, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(300, 100, 0, MS_BUZZ, MZ_LARGE), MR_POISON|MR_PLUSTWO|MR_HITASTHREE|M1_ACID, MR_POISON,
    ...
    /* 5lo: Courier quest only...*/
    MON("cazador", S_ANT, 
	LVL(12, 18, -5, 0, 0), (G_SGROUP|G_NOGEN),
 ...
 */
    ...
    /* 5lo: For the Death Eater quest only... */
    MON("auror", S_ANGEL, 
	LVL(12, 18, -5, 90, 15), (G_NOCORPSE|G_NOGEN),
 ...
 */
	...
	M1_HUMANOID|M1_CARNIVORE,M2_HOSTILE,M3_INFRAVISIBLE, CLR_BLUE),
...
/*      evil coins        */
    ...
    /* 5lo: Grues, Wall Monsters and Rub Monsters are set to nogen - only here currently
     * until we find replacements for these */
    /*
     * Grues
     */
    MON("floor grue", S_GRUE, 
	LVL(0, 4, 10, 0, -5), (G_NOCORPSE|G_NOGEN),
	...
	LVL(0, 2, 10, 0, 5), (G_NOCORPSE|G_NOGEN),
	...
	LVL(0, 2, 10, 0, 0), (G_NOCORPSE|G_NOGEN),
	A(ATTK(AT_LASH, AD_PHYS, 1, 2), ATTK(AT_TRAM, AD_PHYS, 1, 2), NO_ATTK,
	  NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1000, 500, 0, MS_BONES, MZ_LARGE), 0, 0,
    ...
    MON("lightning-proof wall", S_WALLMONST, /* only for a quest */
	...
	LVL(2, 6, 8, 0, -5), (G_NOCORPSE|G_NOGEN),
	...
	LVL(6, 8, 5, 0, -5), (G_NOCORPSE|G_NOGEN),
 ...
 */
	...
	A(ATTK(AT_WEAP, AD_FIRE, 4, 4), ATTK(AT_KICK, AD_ELEC, 5, 5),
	  ATTK(AT_MAGC, AD_COLD, 6, 6), ATTK(AT_GAZE, AD_RUST, 5, 5),
	  ATTK(AT_GAZE, AD_DCAY, 5, 5), ATTK(AT_GAZE, AD_ENCH, 5, 5)),
	SIZ(750, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_STONE, 0,
	...
	M1_MINDLESS|M1_BREATHLESS|M1_OMNIVORE|M1_HUMANOID,
 ...
 */
	...
	CLR_BROWN),
#endif
    MON("Sizzle", S_HUMAN, /* Special monster for Spacewars Fighter quest */
	...
	M2_NOPOLY|M2_HUMAN|M2_PNAME|M2_COLLECT|M2_STALK|M2_MALE, 0, CLR_BRIGHT_GREEN),
