...
coord *mm;
{
	...
	for (ik=0; kop_pm[ik]; ik++) {
	  if (!(mvitals[kop_pm[ik]].mvflags & G_GONE)) {
		...
		case 9:
		case 10:
		(void) makemon(&mons[PM_ANGRY_WATCHMAN], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 11:
		case 12:
		case 13:
		case 14:
		...
		case 29:
		case 30:
		(void) makemon(&mons[PM_SOLDIER], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 31:
		case 32:
		case 33:
		case 34:
		...
		case 99:
		case 100:
		(void) makemon(&mons[PM_KEYSTONE_KOP], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 101:
		case 102:
		case 103:
		case 104:
		case 105:
		case 106:
		(void) makemon(&mons[PM_ANGRY_WATCH_CAPTAIN], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 107:
		case 108:
		case 109:
		case 110:
		...
		case 115:
		case 116:
		(void) makemon(&mons[PM_SERGEANT], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 117:
		case 118:
		case 119:
		case 120:
		...
		case 149:
		case 150:
		(void) makemon(&mons[PM_KOP_SERGEANT], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 151:
		case 152:
		case 153:
		(void) makemon(&mons[PM_ANGRY_WATCH_LIEUTENANT], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 154:
		case 155:
		case 156:
		case 157:
		case 158:
		(void) makemon(&mons[PM_LIEUTENANT], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 159:
		case 160:
		case 161:
		case 162:
		...
		case 179:
		case 180:
		(void) makemon(&mons[PM_KOP_LIEUTENANT], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 181:
		case 182:
		case 183:
		(void) makemon(&mons[PM_CAPTAIN], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 184:
		case 185:
		case 186:
		case 187:
		...
		case 190:
		case 191:
		(void) makemon(&mons[PM_KOP_KAPTAIN], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 192:
		(void) makemon(&mons[PM_GENERAL], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 193:
		case 194:
		case 195:
		case 196:
		case 197:
		(void) makemon(&mons[PM_KOP_KOMMISSIONER], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 198:
		case 199:
		case 200:
		(void) makemon(&mons[PM_KOP_KCHIEF], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 201:
		(void) makemon(&mons[PM_ARCH_LICH], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 202:
		(void) makemon(&mons[PM_ANGRY_WATCH_LEADER], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
		case 203:
		(void) makemon(&mons[PM_KOP_KATCHER], mc[cnt].x, mc[cnt].y, NO_MM_FLAGS);
