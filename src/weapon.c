...
struct monst *mon;
{
	...
	boolean Is_weapon = (otmp->oclass == WEAPON_CLASS || otmp->oclass == BALL_CLASS || otmp->oclass == CHAIN_CLASS || is_weptool(otmp));
...
static const NEARDATA short hwep[] = {
	...
	IRON_CHAIN,
	  ...
	  GREEN_LIGHTSABER,
#endif
	  TWO_HANDED_SWORD, BATTLE_AXE, BATTLE_STAFF,
	  KATANA, UNICORN_HORN, CRYSKNIFE, ELECTRIC_SWORD, TRIDENT, LONG_SWORD,
	  ELVEN_BROADSWORD, BROADSWORD, SCIMITAR, SILVER_SABER, THORNED_CHAINWHIP,
